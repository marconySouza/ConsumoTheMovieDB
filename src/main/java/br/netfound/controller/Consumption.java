...
public class Consumption {
	...
	public static void main(String[] args) throws Exception {
		...
		JSONArray array = (JSONArray) new JSONParser().parse(new FileReader("C:/Users/Login/Desktop/tv_series_ids_11_16_2020.json")); 
		JSONObject obj;		
		for (int k = 0; k < array.size(); k++) {
			obj = (JSONObject) array.get(k);
			getMoviesJSON((Long)obj.get("id"));
	...
	public static void getGenreJSON() throws Exception {
		...
		HttpResponse<String> response = Unirest
				.get("https://api.themoviedb.org/3/genre/movie/list?api_key=" + apiKey + "&language=" + language).asString();
	...
	public static void getMoviesJSON(Long movieNumber)
			throws Exception {
		...
		Unirest.setTimeouts(0, 0);
		response = Unirest
				.get("https://api.themoviedb.org/3/movie/" + movieNumber + "?api_key=" + apiKey + "&language=" + language)
				.asString();
